<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Add Hero Banner</h2>
        <form action="{{ route('hero.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-input-error class="mt-2" :messages="$errors->get('images_en')" />
                </div>
                ...
                <div>
                    ...
                    <x-input-error class="mt-2" :messages="$errors->get('images_ch')" data-lang="ch" />
                </div>
            </div>
