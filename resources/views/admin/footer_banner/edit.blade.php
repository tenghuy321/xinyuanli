<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Footer Banner</h2>
        <form action="{{ route('footer-banner.update', $footer_banner->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $footer_banner->title['en'] ?? '') }}" type="text"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.ch', $footer_banner->title['ch'] ?? '') }}" type="text"
            ...
            <!-- Dropzone for Image -->
            @if (!empty($footer_banner->image))
                <div>
                    <label for="dropzone-file{{ $footer_banner->id }}" id="drop-area"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                            id="img-preview" style="background-image: url({{ asset($footer_banner->image) }})">
                        ...
                        <input id="dropzone-file{{ $footer_banner->id }}" type="file" class="hidden" name="image"
            ...
            <div class="flex justify-between">
                <a href="{{ route('footer-banner.index') }}"
