<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('ourService.update', $our_service->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $our_service->title['en'] ?? '') }}" type="text" name="title[en]"
                            id="title_en"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.ch', $our_service->title['ch'] ?? '') }}" type="text" name="title[ch]"
                            id="title_ch"
                            class="mt-1 block w-full p-2 border rounded-md focus:ring-[#DFAD16] focus:border-[#DFAD16] text-black text-sm">
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $our_service->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($our_service->icon) }})">
                    ...
                    <input id="dropzone-file{{ $our_service->id }}" type="file" class="hidden" name="icon" accept="image/*"
